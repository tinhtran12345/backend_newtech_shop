...
-- AddForeignKey
ALTER TABLE "Variant_values" ADD CONSTRAINT "Variant_values_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "Product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
